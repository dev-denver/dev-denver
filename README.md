...
단순히 기능이 동작하는 코드를 작성하는 것을 넘어, **유지보수가 쉽고 확장 가능한 구조**를 고민하며 개발합니다.

---

### 💼 Business First

* 비즈니스와 도메인에 대한 깊은 이해를 바탕으로 문제를 해결합니다.
* 요구사항의 배경과 정책을 함께 고려하여 개발합니다.
* 기술보다 **왜 필요한 기능인지**를 먼저 고민합니다.

### 🏗 Clean Architecture

* 읽기 쉽고 유지보수하기 좋은 코드를 작성합니다.
* 확장성을 고려한 구조를 설계합니다.
* 변화에 유연하게 대응할 수 있는 시스템을 지향합니다.

### 🤖 AI Assisted Development

AI를 단순한 코드 생성 도구로 사용하지 않습니다.
